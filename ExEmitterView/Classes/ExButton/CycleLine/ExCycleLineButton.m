...
//  ExEmitterView
//
//  Created by ecarx on 2019/12/27.
//
...
@interface ExCycleLineButton() <CAAnimationDelegate>
...
@implementation ExCycleLineButton
...
+ (instancetype)CycleLinebuttonWithTitle:(NSString *)title tapAction:(clickActionBlock)action {
    ExCycleLineButton *button = [[ExCycleLineButton alloc]init];
