//
//  NSLayoutConstraint+ExDownloadButton.m
//  ExEmitterView
//
...
@implementation NSLayoutConstraint (ExDownloadButton)
...
+ (NSArray *)horizontalConstraintsForWrappedSubview:(UIView *)view withInsets:(UIEdgeInsets)insets {
    ...
    NSArray *horizontalConstraints = [NSLayoutConstraint constraintsWithVisualFormat:horizontalConstraintsFormat options:0 metrics:nil views:NSDictionaryOfVariableBindings(view)];
...
+ (NSArray *)verticalConstraintsForWrappedSubview:(UIView *)view withInsets:(UIEdgeInsets)insets {
    ...
    NSArray *verticalConstraints = [NSLayoutConstraint constraintsWithVisualFormat:verticalConstraintsFormat options:0 metrics:nil views:NSDictionaryOfVariableBindings(view)];
...
+ (NSArray *)constraintsForView:(UIView *)view withSize:(CGSize)size {
    NSLayoutConstraint *width = [NSLayoutConstraint constraintForView:view withWidth:size.width];
    NSLayoutConstraint *height = [NSLayoutConstraint constraintForView:view withHeight:size.height];
    return @[width, height];
}
...
+ (NSLayoutConstraint *)constraintForCenterByXView:(UIView *)overlay withView:(UIView *)view {
    return [NSLayoutConstraint constraintWithItem:overlay attribute:NSLayoutAttributeCenterX relatedBy:NSLayoutRelationEqual toItem:view attribute:NSLayoutAttributeCenterX multiplier:1.0 constant:0.0];
}

+ (NSLayoutConstraint *)constraintForCenterByYView:(UIView *)overlay withView:(UIView *)view {
    return [NSLayoutConstraint constraintWithItem:overlay attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:view attribute:NSLayoutAttributeCenterY multiplier:1.0 constant:0.0];
}
